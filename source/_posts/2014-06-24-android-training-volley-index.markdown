---
layout: post
title: "Android Training - Volley(Lesson 0 - 序言)"
date: 2014-06-24 08:30
comments: true
sidebar: false
...
## Lessons
* [发送一个简单的网络请求(Sending a Simple Request)](http://hukai.me/blog/android-training-volley-simple-request/)

学习如何通过Volley默认的行为发送一个简单的请求，以及如何取消一个请求。

* [建立一个请求队列(Setting Up a RequestQueue)](http://hukai.me/blog/android-training-volley-request-queue/)

学习如何建立一个请求队列，以及如何实现一个单例模式来创建一个请求队列。

* [生成一个标准的请求(Making a Standard Request)](http://hukai.me/blog/android-training-volley-standard-request/)

学习如何使用Volley的out-of-the-box的请求类型(raw strings, images, and JSON)来发送一个请求。

* [实现自定义的请求(Implementing a Custom Request)](http://hukai.me/blog/android-training-volley-custom-request/)

学习如何实现一个自定义的请求


***
**学习自<http://developer.android.com/training/volley/index.html>,欢迎交流讨论**
